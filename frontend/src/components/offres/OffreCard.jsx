...
const OffreCard = ({ offre, onPublier, onFermer, onSupprimer }) => {
  ...
  return (
    <div className={`${styles.offreCard} ${!offre.est_active ? styles.inactive : ''}`}>
      <div className={styles.offreHeader}>
        ...
        <div className={styles.offreStatus}>
          <span className={`${styles.statusBadge} ${offre.est_active ? styles.active : styles.inactive}`}>
      ...
      <div className={styles.offreInfo}>
        <div className={styles.infoItem}>
          ...
          <span className={styles.infoValue}>{offre.entreprise?.raison_social || 'N/A'}</span>
        </div>
      ...
      <div className={styles.offreActions}>
        ...
        {canModify && (
          <>
            <Link to={`/offres/modifier/${offre.id}`} className={styles.editButton}>
              Modifier
            </Link>
